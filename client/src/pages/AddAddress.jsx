...
const AddAddress = () => {
  ...
  return (
    <div className='mt-16 pb-16'>
     ...
     <div className='flex flex-col-reverse md:flex-row justify-between mt-top'>
        <div className='flex-1 mx-w-md'>
            <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                ...
                <InputField handleChange={handleChange} address={address} name="email" type="text"
                    placeholder="Email" />
                <InputField handleChange={handleChange} address={address} name="street" type="text"
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                    ...
                    <button className='w-full mt-6 bg-zinc-500 text-white py-3 hover:bg-primary-dull transition
